    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-lg-5">
          ...
          <form id="calculate" action="{{ url('/sub') }}" method="post">
    @csrf
    <div class="row">
        <div class="col-lg-6">
            <fieldset>
        ...
        <div class="col-lg-12">
            <fieldset>
                ...
                <select name="category" class="form-select" aria-label="Default select example" id="chooseOption">
        ...
        <div class="col-lg-12">
            <fieldset>
            <button type="submit" id="form-submit" class="orange-button" onclick="return confirm('Are you sure you want to submit?'); submit_click();">Submit Now</button>
        ...
        <div class="row">
            ...
            <div class="col-lg-10 offset-lg-1">
                <div class="owl-testimonials owl-carousel" style="position: relative; z-index: 5;">
                    @foreach($staticTestimonials as $testimonial)
                        <div class="item">
